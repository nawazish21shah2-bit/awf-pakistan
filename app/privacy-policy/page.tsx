...
export const metadata: Metadata = {
  title: "Privacy Policy | Arrahman Welfare Foundation Pakistan",
  description: "Privacy Policy for Arrahman Welfare Foundation Pakistan.",
};
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc]">
      ...
      <PKPageHero
        ...
        description="How Arrahman Welfare Foundation Pakistan collects, protects, and handles personal data and donor information in accordance with applicable data privacy standards in Pakistan."
        breadcrumbs={[
          { label: "Home", href: "/" },
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="bg-white p-8 sm:p-10 rounded-3xl border border-gray-100 shadow-sm space-y-6 text-muted text-sm sm:text-base leading-relaxed">
          ...
          <p>
            We do not sell, rent, or lease donor lists to third parties. All financial transactions conducted via bank wire or authorized partners are logged under strict internal controls and encrypted protocols.
          </p>

          <h2 className="text-xl font-display font-bold text-primary pt-2">3. Scholar-Supervised Zakat Execution</h2>
          <p>
            All Zakat proceeds are kept strictly segregated from general operational expenses, delivering full value directly to certified eligible recipients across Pakistan.
          </p>
        </div>
      </main>
    </div>
